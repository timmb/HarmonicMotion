...
//	/// This is not templated to make it easier to deal with collections of
//	/// filters. But any implementation must return the same DataType that
//	/// it receives
//	class Filter
//	{
//	public:
//		template <typename U>
//		virtual DataType const& update(U const& x) = 0;
//	};
	...
	, mFilteredValue(T())
	{
		...
		mCoefficients = {
			-0.070588235294117646, -0.011764705882352941, 0.038009049773755653,  0.078733031674208143,  0.11040723981900452,
			0.1330316742081448,    0.14660633484162897,  0.151131221719457,     0.14660633484162897,   0.1330316742081448,
